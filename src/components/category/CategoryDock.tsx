...
export const CategoryDock = () => {
  ...
  return (
    <div className="w-full max-w-[92vw] md:max-w-max px-2">
      <div className="bg-white/90 backdrop-blur-xl border border-stone-100 rounded-full p-1.5 shadow-[0_20px_50px_-12px_rgba(24,24,27,0.18)] overflow-x-auto no-scrollbar flex items-center gap-1">
