  ...
  return (
    <section className="bg-white py-16">
      <div className="px-4 md:px-8 lg:px-12 w-full">
        {/* Tab Navigation */}
        <div className="flex flex-wrap justify-center gap-8 md:gap-12 mb-12 border-b border-stone-200">
            ...
            return (
              <button
                ...
                className={`flex items-center gap-2 pb-2 -mb-[1px] border-b-4 transition-colors duration-300 font-medium ${
                  isActive 
                    ? 'text-brass-600 border-brass-600' 
          ...
          >
            {currentCategory.images.map((imgUrl, index) => (
              <div key={index} className="flex flex-col group cursor-pointer">
                ...
                <h3 className="mt-4 text-base font-bold text-stone-900 group-hover:text-brass-600 transition-colors">
                  {CARD_LABELS[index]}
                </h3>
              </div>
            ))}
